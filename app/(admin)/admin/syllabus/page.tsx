...
export default async function AdminSyllabusPreviewPage() {
  ...
  return <div className="academic-page academic-admin-page">
    <section className="academic-hero"><div><Badge tone="warning">Operations registry</Badge><h1>Syllabus structure</h1><p>Review normalized syllabus versions, source verification and retained history. Phase 12 controlled status changes are available through the operations content workspace.</p></div><div className="academic-source-chip"><Icon name="shield" size={18}/><span><strong>Controlled Phase 12 writes</strong><small>Changes use server authorization and immutable operations auditing.</small></span></div></section>
