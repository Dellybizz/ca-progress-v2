...
export default async function TodayPlanPage() {
  ...
  return <div className="phase9-page today-plan-page a2-planning-page">
    ...
    <div className="button-row today-primary-actions" aria-label="Today actions"><Link href="/study" className="ui-button ui-button--primary">Start Focus</Link><Link href="#study-order" className="ui-button ui-button--secondary">Rearrange</Link><Link href="/planner?create=1" className="ui-button ui-button--secondary">Add Task</Link><Link href="/planner" className="ui-button ui-button--secondary">View Full Planner</Link></div>
