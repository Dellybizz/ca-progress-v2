...
export default async function TodayPlanPage() {
  ...
  return <div className="phase9-page today-plan-page">
    ...
    <section className="phase9-metrics" aria-label="Today overview"><Card><CardBody><Icon name="calendar"/><div><span>Days remaining</span><strong>{daysRemaining ?? "—"}</strong><small>{countdownNote}</small></div></CardBody></Card><Card><CardBody><Icon name="target"/><div><span>Planned study</span><strong>{model.plannedMinutes}m</strong><small>fixed and flexible work</small></div></CardBody></Card><Card><CardBody><Icon name="clock"/><div><span>Completed today</span><strong>{completedStudyMinutes}m</strong><small>from finished study sessions</small></div></CardBody></Card></section>
