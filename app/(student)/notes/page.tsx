...
export default async function NotesPage() {
  ...
  return <div className="phase7-page"><PageHeader preview={false} eyebrow="Personal library" title={`Your notes and resources, ${model.viewerName}.`} description="Write rich-text notes, keep files private by default, or submit selected resources to the moderated Community library."/><ResourceLibrary model={model} initialTab="my"/></div>;
}
