...
export default async function Page() {
  ...
  return <div className="settings-v2-page">
    ...
    <Card className="settings-profile-entry"><CardBody><span className="settings-profile-entry__icon"><Icon name="download"/></span><div><strong>Data export</strong><p>{planLabel} plan</p></div><div className="phase11-header-links">{canExportProgress ? <a href="/api/exports/progress" download>Progress PDF</a> : <Link href="/login">Sign in to export</Link>}<span aria-disabled="true">Study CSV · Pro</span><span aria-disabled="true">Test History CSV · Pro</span><span aria-disabled="true">Full Backup · Premium</span></div></CardBody></Card>
