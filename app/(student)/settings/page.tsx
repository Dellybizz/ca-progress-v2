...
export default async function Page() {
  ...
  return <div className="settings-v2-page">
    <Card><CardHeader title="Appearance" description="Choose how CA Progress looks and moves on this device."/><CardBody><AppearanceControls/></CardBody></Card>
    <Card><CardHeader title="Focus" description="Choose what happens when a Focus session finishes on this device."/><CardBody><FocusPreferences/></CardBody></Card>
    ...
    <Card className="settings-profile-entry"><CardBody><span className="settings-profile-entry__icon"><Icon name="book"/></span><div><strong>Offline data on this device</strong><p>Cached student screens and queued edits are isolated to your signed-in account. Admin, billing and temporary file links are never stored.</p></div><OfflineControls/></CardBody></Card>
  </div>;
}
