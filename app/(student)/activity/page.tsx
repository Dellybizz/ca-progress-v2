  ...
  return <div className="phase6-page">
    ...
    <Card><CardBody>
      <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit,minmax(150px,1fr))", gap: 16 }}>
        <div><small>Professional level</small><h3>{gamification.level.name}</h3><p>{gamification.totalXp.toLocaleString()} XP</p></div>
      ...
      {gamification.level.nextMinXp !== null ? <p style={{ marginTop: 16 }}>{gamification.level.nextMinXp - gamification.totalXp} XP to {gamification.level.nextName}. Level progress: {gamification.level.progressPercent}%.</p> : <p style={{ marginTop: 16 }}>Highest professional preparation level reached.</p>}
