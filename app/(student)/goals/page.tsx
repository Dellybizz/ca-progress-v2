...
export default async function Page() { const model = await getGoalsPageModel(); if (model.mode === "guest") return <div className="phase6-page">
  <PageHeader preview={false} eyebrow="Goals" title="Set milestones with real due dates." description="Browse the goals page as a guest. Saving personal milestones requires sign-in." actions={<div className="phase6-header-links"><Link href="/planner">Planner</Link><Link href="/calendar">Calendar</Link></div>}/>
