...
export function MobileNavigation({ area }: { area: "student" | "admin" }) {
  ...
  const moreActive = ["/planner", "/analytics", "/goals", "/calendar", "/activity", "/syllabus", "/subjects", "/updates", "/tests", "/notes", "/resources", "/community", "/settings"].some((href) => pathname.startsWith(href)) && !pathname.startsWith("/planner/today");
