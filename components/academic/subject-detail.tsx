...
export function SubjectDetail({ subject, context }: { subject: AcademicSubject; context?: { level?: string | null; group?: string | null; attempt?: string | null } }) {
  return <div className="academic-page academic-subject-page" id="top">
    ...
    <section className="academic-progress-readiness"><Icon name="layers" size={19}/><div><strong>Canonical Chapter Hubs are live</strong><p>Progress, study time, notes, files, Doubts and verified ICAI resources are joined around the same chapter IDs already used by the progress system.</p></div><Badge tone="success">Connected</Badge></section>
