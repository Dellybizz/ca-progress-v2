...
export function ProgressPage({ model, subjectLocked = false, next = "/progress", initialChapterId }: { model: ProgressPageModel; subjectLocked?: boolean; next?: string; initialChapterId?: string }) {
  if (model.mode === "guest") return (
    <div className="progress-page">
      <PageHeader preview={false} eyebrow="Progress tracker" title="Track every chapter without losing history." description="Browse how chapter tracking works. Sign in only when you want to save your own completion, revision or marks-driven test milestones." />
