...
test("Phase 9 remains implemented after the V2 staging label advances to Phase 10", () => {
  ...
  assert.match(read("app/globals.css"), /phase9\.css/);
});

test("Phase 9 source migration did not start Phase 10 Community or Phase 11 billing work", () => {
  ...
  assert.doesNotMatch(migration, /community_messages|community_channels|subscription_entitlements/);
});
