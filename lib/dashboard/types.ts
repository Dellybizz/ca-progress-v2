export type DashboardActionKey =
  "start_study" | "add_task" | "add_note" | "open_progress";
...
export type DashboardReadyModel = {
  ...
  countdown: {
    status:
      "scheduled" | "exam_period" | "completed" | "awaiting_verified_date";
    ...
    sourceKind: "exam_event" | "admin_estimate" | "none";
