...
export type ChapterHubAcademic = {
  ...
  syllabusVersionKey: string;
  syllabusVersionTitle: string;
};
...
export type ChapterHubProgressEvent = {
  id: string;
  stage: ProgressStage;
  action: string;
  createdAt: string;
...
export type ChapterHubDoubtChannel = {
  id: string;
  channelKey: string;
  title: string;
  description: string;
...
export type ChapterHubOfficialResource = {
