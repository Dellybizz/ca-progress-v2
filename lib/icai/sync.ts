...
export type IcaiSyncContinuationSourceResult = { runId:string;sourceId:string;status:"continuing"|"paused"|"succeeded"|"failed"|"skipped"|"cancelled";requestIntervalSeconds:number;alreadyComplete:boolean;cursorOffset?:number;cursorTotal?:number };
