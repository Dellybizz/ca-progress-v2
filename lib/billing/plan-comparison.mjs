...
export const PLAN_COMPARISON_ROWS = Object.freeze([
  ...
  Object.freeze({ key: "analytics", label: "Advanced analytics", featureKey: "advanced_analytics", detail: "Deeper history and paid analysis views" }),
  ...
  Object.freeze({ key: "premium-insights", label: "Premium insight layer", featureKey: "advanced_preparation", detail: "Advanced preparation, forecasts, history and recovery planning" }),
