...
const FEATURES: readonly Omit<MobileFeatureParity, "analytics">[] = [
  ...
  },
  {
    ...
    label: "Community",
    href: "/community",
    mobileLayout: "channel-first chat with presence and typing state",
    offline: "online",
    permission: "guest",
    synchronization: "authorized Durable Object realtime with bounded polling fallback",
    failureState: "connection state, reconnect and safe read-only fallback",
  },
  {
    id: "notifications",
    label: "Notifications",
    ...
    offline: "online",
    permission: "account",
    synchronization: "v1 notification center and account-bound Web Push subscription",
